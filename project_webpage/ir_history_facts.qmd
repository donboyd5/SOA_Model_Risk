...
Now we examine characteristics of returns from six U.S. asset classes using data compiled by Aswath Damodaran at New York University. For details, see the documentation in the [Appendix](appdx_damodaran_data.qmd). The asset classes are:
...
measures |> 
  ...
  tab_source_note(source_note="Source: Aswath Damodaran, New York University")
...
portmeas |> 
  gt() |> 
   tab_header(
    title = html("Summary measures for selected U.S. asset classes and portfolios, 1928-2022"),
    subtitle=html("Based on annual returns")
  ) |>
  cols_label(name=html("Asset class"),
             skew = html("Skewness"),
...
## Impact of data frequency on summary measures of investment returns
