...
figure_Vloss_model
ggsave(
  filename = here::here("report", "results", "Figure_vloss_model.png"),
...
ggsave(
  filename = here::here("report", "results", "Figure_VERC_model.png"),
...
# gtsave(tab, "parm_risk_measures_highfixed_table.png", path = here::here("report", "results"))
...
p
ggsave(
  filename = here::here("report", "results", "FigureVaRLoss.png"),
  plot = p,
  width = 10,
  height = 6,
  scale = 1.5
...
p
ggsave(
  filename = here::here("report", "results", "FigureVaRERC.png"),
  plot = p,
  width = 10,
  height = 6,
  scale = 1.5
