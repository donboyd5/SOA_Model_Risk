...
# commented-out returns were from when I had calculated portfolio returns using weighted log returns rather than the
# better (correct) approach of converting to arithmetic, getting weighted arithmetic portfolio return, then calc'ing port log return
...
mean_annual_logreturn_highequity <- acli_means$lr[acli_means$porttype=="highequity"]
mean_annual_logreturn_highfixed <-acli_means$lr[acli_means$porttype=="highfixed"]
