...
combo2 <- readRDS(fs::path(GROOT, "data", "slv_assets_rawdaily.rds"))
...
saveRDS(aggrport2, fs::path(GROOT, "data", "simportfolios_rawdaily.rds"))

# take a look
# tmp <- readRDS(fs::path(GROOT, "data", "simportfolios_rawdaily.rds"))
# ht(tmp)
...
port_monthly1 <- readRDS(fs::path(GROOT, "data", "simportfolios_rawdaily.rds"))
...
saveRDS(
  ...
  fs::path(GROOT, "data", "slv_model_results.rds")
)
...
modlist <- readRDS(fs::path(GROOT, "data", "slv_model_results.rds")) # 8 models
res2 <- modlist$res2
...
saveRDS(sims, fs::path(GROOT, "data", "slvsims_sims_by_months.rds"))
...
sims <- readRDS(fs::path(GROOT, "data", "slvsims_sims_by_months.rds"))
...
saveRDS(
  ...
  fs::path(GROOT, "data", "slvsims.rds")
)
