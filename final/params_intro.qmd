...
IG_Long.csv, Investment grade long corporates
"
...
rho_m.05, Correlation to random shock to vol and random return component (rho) reduced by .05 for each equity fund
rho_p.05, Correlation to random shock to vol and random return component (rho) increased by .05 for each equity fund
